      ...
      <div className="mt-4 relative">
        ...
        <div className="relative"> {/* Container for Swiper and desktop arrows */}
          ...
          >
            ...
            {isDesktop && (
              <SwiperSlide>
                {/* Desktop: "What We Do" List Slide with Grainy Background and Side Images */}
                <div className="hidden md:flex flex-row justify-center items-center h-auto md:h-[80vh] relative p-16">
                  ...
                  {/* Center text content */}
                  <div className="relative z-10 flex flex-col justify-center items-center text-center text-black max-w-2xl mx-8">
                  ...
                  {/* Right image */}
                  <div className="flex-shrink-0 hidden lg:block ml-8 z-10">
                    <Image
                      src="/images/Walking_dog.png"
                      alt="Dog walking helper"
                      width={180}
                      height={260}
                      className="object-contain"
                    />
