...
const Slideshow = () => {
  return (
    <div className="mt-4 relative">
            ...
            <div className="flex flex-col md:flex-row h-auto md:h-[80vh] relative bg-gray-100 md:bg-gray-300">
              ...
              <div className="md:hidden relative flex flex-col items-center justify-start px-4 pt-8 pb-0 w-full bg-gray-100">
                ...
                <div className="w-[110%] flex flex-col items-center relative z-0">
                  <div
                    className="w-full bg-red-600 flex flex-col items-center pt-16 pb-6 relative overflow-hidden"
                ...
                <div className="w-[110%] flex flex-col items-center pt-6 pb-8 bg-gray-100">
                  <Button className="w-[110%] flex items-center justify-center gap-2 px-4 py-5 rounded-full text-xl font-semibold bg-black text-white border-none shadow-md max-w-sm mx-auto">
                    <PhoneOvalIcon />
              ...
              <div className="md:hidden relative flex flex-col items-center justify-start pt-8 pb-0 w-full overflow-visible">
                ...
                <div className="w-full bg-black pb-0"> 
                  ...
                  <div className="w-[100%] flex flex-col items-center relative z-0 mx-auto">
                    ...
                    <div
                      ...
                      style={{ borderTopLeftRadius: '50%', borderTopRightRadius: '50%' }}
                    >
                      <p className="text-center text-2xl font-bold text-white mb-13">Satisfaction Guaranteed!</p>
                      <Link href="/book" passHref>
                        <Button asChild className="bg-black text-base text-white rounded-full px-8 py-4 font-semibold shadow-md hover:scale-105 transition-transform w-full max-w-xs">
                          Book online now
                        </Button>
                ...
                <div className="w-full bg-gray-100 pt-6 pb-8"> 
                  ...
                  <div className="px-4 flex flex-col items-center">
                    <Button className="w-full flex items-center justify-center gap-2 py-5 rounded-full text-xl font-semibold bg-black text-white border-none shadow-md max-w-sm mx-auto"> 
                      <PhoneOvalIcon />
                      <span>Call us or book online</span>
                    </Button>
                  </div>
      ...
      {/* Grey Square with Ovals - Moved outside Swiper, responsive, hidden on mobile */}
      <div className="w-full bg-gray-200 hidden md:flex flex-col md:flex-row justify-center items-center gap-3 md:gap-8 p-3 md:p-4"> {/* Hidden on mobile */}
        <Button className="w-full md:w-auto flex items-center justify-center gap-2 px-4 md:px-10 py-3 md:py-7 rounded-full text-base md:text-lg font-medium cursor-pointer transition-transform hover:scale-105 bg-red-600 hover:bg-red-600 text-white border-none">
          <PhoneOvalIcon />
          <span>1300 396 316</span>
        </Button>
        <Button className="w-full md:w-auto flex items-center justify-center gap-2 px-4 md:px-10 py-3 md:py-7 rounded-full text-base md:text-lg font-medium cursor-pointer transition-transform hover:scale-105 bg-gray-200 hover:bg-gray-200 text-black border-2 border-[#4B4B4B]">
          <ClockIcon />
          <span>Request Callback</span>
        </Button>
        <Link href="/book" passHref className="w-full md:w-auto">
          <Button asChild className="w-full md:w-auto flex items-center justify-center gap-2 px-4 md:px-10 py-3 md:py-7 rounded-full text-base md:text-lg font-medium cursor-pointer transition-transform hover:scale-105 bg-gray-200 hover:bg-gray-200 text-black border-2 border-[#4B4B4B]">
            <span>
              <LaptopBlackIcon />
