  ...
  return (
    <>
      <div className="mt-4 relative">
        ...
        <div className="md:hidden flex flex-col justify-center items-center pt-6 pb-6 bg-gray-100">
          <svg 
        ...
        <div className="w-full bg-gray-200 hidden md:flex flex-col md:flex-row justify-center items-center gap-3 md:gap-8 p-3 md:p-4"> {/* Hidden on mobile */}
          <Button asChild className="w-full md:w-auto flex items-center justify-center gap-2 px-4 md:px-10 py-3 md:py-7 rounded-full text-base md:text-lg font-medium cursor-pointer transition-transform hover:scale-105 bg-red-600 hover:bg-red-600 text-white border-none">
            <a href="tel:1300396316">
              <PhoneOvalIcon />
          ...
          <Button 
            ...
            className="w-full md:w-auto flex items-center justify-center gap-2 px-4 md:px-10 py-3 md:py-7 rounded-full text-base md:text-lg font-medium cursor-pointer transition-transform hover:scale-105 bg-gray-200 hover:bg-gray-200 text-black border-2 border-[#4B4B4B]"
          >
            <ClockIcon />
