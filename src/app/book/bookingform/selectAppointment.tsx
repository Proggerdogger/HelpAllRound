  ...
  const generateDates = () => {
    ...
    return Array.from({ length: 7 }, (_, i) => {
      ...
      return {
        ...
        fullDate: date.toISOString().split("T")[0], // YYYY-MM-DD for comparison and API calls
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {selectedDate && (
            <div className="mb-6">
              ...
              {!isLoadingSlots && unavailableSlots.length === timeSlots.length && timeSlots.length > 0 && (
                <p className="text-red-500">No time slots available for this date. Please select another date.</p>
              )}
              {!isLoadingSlots && (
