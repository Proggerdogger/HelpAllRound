...
const SelectAppointment: React.FC<SelectHelperProps> = ({ onBack, onNext, onDataUpdate, formData }) => {
                    ...
                    >
                      <div
                        className={`text-sm font-semibold ${
                          selectedDate === date.fullDate ? "text-gray-600" : "text-gray-500"
                        }`}
                      >
                        {date.day}
                      </div>
                      <div
                        className={`text-xs font-semibold -mt-1 ${
                          selectedDate === date.fullDate ? "text-black" : "text-black"
                        }`}
                      >
                        {date.date}
                      </div>
                      <div
                        className={`text-xs mt-1 font-semibold ${
                          selectedDate === date.fullDate ? "text-red-600" : "text-red-500"
                        }`}
                      >
                        From ${date.price}
                      </div>
