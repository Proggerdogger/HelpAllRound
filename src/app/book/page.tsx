...
export default function StartBookingPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header_BookPage />
      <main className="flex flex-col lg:flex-row items-start px-4 pt-24 pb-4 lg:pb-12 max-w-6xl mx-auto">
        {/* Left: Booking/Phone Options */}
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start mb-11 lg:mb-0 lg:translate-x-[30%]">
      ...
      <div className="md:hidden flex flex-col justify-center items-center pt-0 pb-0 bg-gray-50">
        <svg 
        ...
        <span className="mt-2 text-sm text-gray-700">Why you'll love us</span>
      </div>
