...
const Header_BookPage = () => {
  return (
    <header className="absolute top-0 left-68.5 right-0 flex items-center p-6">
      {/* Logo aligned to the left with margin */}
      <div className="text-4xl font-bold text-red-600 ml-8">HelpAllRound</div>
    </header>
  );
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row items-start px-4 pt-24 pb-12 max-w-6xl mx-auto">
        ...
        <div className="lg:w-1/2 flex flex-col items-start mb-12 lg:mb-0 translate-x-[30%]">
          <div className="flex flex-col items-start space-y-6">
            ...
            <div className="w-64 bg-black text-white flex items-center justify-center space-x-3 py-4 px-6 rounded-lg">
              <svg
                width="24"
                height="24"
                viewBox="0 0 32 32"
