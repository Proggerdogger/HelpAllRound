...
const ReasonsSection = () => {
  ...
  const reasons = [
    ...
    },
    {
      ...
      description:
        'Often, our customers have more than one issue that they need assistance with. Luckily, our Helpers have experience in a variety of different situations, so you can use your service to sort out all of your issues in one go.',
    },
    {
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/3 flex justify-center">
          <Image
            ...
            onError={() => console.error('Failed to load image: /images/heart.jpg')}
          />
        </div>
        {/* Right Side: Reasons */}
