    ...
    <header className="p-4">
      ...
      <div className="hidden md:flex justify-between items-start">
        ...
        <div className="flex flex-col items-start mt-4 ml-4">
          <Link href="/" passHref>
            <div className="text-4xl font-bold text-red-600 cursor-pointer hover:opacity-80 transition-opacity">
              HelpAllRound
            </div>
          </Link>
          <p className="text-sm text-gray-600 ml-1">Available in Canberra and surrounding suburbs</p>
        </div>
              ...
              <Tooltip>
                <TooltipTrigger>
                  <div className="flex flex-col items-center">
                    <PhoneIcon />
                    <a href="tel:1300396316" className="text-base text-red-600 mt-1 relative group">
                      1300 396 316
      ...
      <div className="md:hidden flex flex-col items-center">
        ...
        <p className="text-xs text-gray-600">Available in Canberra and surrounding suburbs</p>
      </div>
    </header>
  );
};
