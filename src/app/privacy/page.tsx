      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <section className="space-y-6 text-gray-700">
          ...
          <article className="space-y-3">
            ...
            <p>Some customers like to engage with us through social media channels. We may collect information about you when you interact with us through these channels.</p>
